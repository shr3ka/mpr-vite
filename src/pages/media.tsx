...
const ELECTIONS = [
  {
    ...
    accent: "#e05a35",
    images: [
      { src: "/lok-sabha/img1.jpg", caption: "Rally at Anandpur Sahib, Punjab" },
      { src: "/lok-sabha/img2.jpg", caption: "Shri Bhagwat Mann, C.M. Punjab" },
      { src: "/lok-sabha/img3.jpg", caption: "Ground team briefing, Punjab" },
      { src: "/lok-sabha/img4.jpg", caption: "Victory Celebration, Punjab" },
      { src: "/lok-sabha/img5.jpg", caption: "Voter Booth Campaign, Anandpur Sahib" },
      { src: "/lok-sabha/img6.jpg", caption: "AAP Party Members, Anandpur Sahib" },
      { src: "/lok-sabha/img7.jpg", caption: "Campaign Team, Anandpur Sahib" },
      { src: "/lok-sabha/img8.jpg", caption: "Arvind Kejriwal at Anandpur Sahib" },
    ],
  },
  {
    id: "maharashtra",
    ...
    accent: "#d4801e",
    images: [
      { src: "/maharashtra/img1.jpg", caption: "Door-to-door campaign, Pune" },
      { src: "/maharashtra/img2.jpg", caption: "Karyakarta rally, Nashik" },
      { src: "/maharashtra/img3.jpg", caption: "Media briefing, Mumbai" },
      { src: "/maharashtra/img4.jpg", caption: "Counting day, Nagpur" },
      { src: "/maharashtra/img5.jpg", caption: "Victory parade, Aurangabad" },
    ],
  },
  {
    id: "delhi",
